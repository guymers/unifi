...
The latest version is Unifi Controller v10.1.89 [Change Log](https://community.ui.com/releases/UniFi-Network-Application-10-1-89/625f366f-7ea5-4266-bd9f-500180494035)
...
docker run -d --init \
   ...
   --user unifi \
   --name unifi \
   ghcr.io/guymers/unifi:v10.1.89
```
