...
The latest version is Unifi Controller v10.0.160 [Change Log](https://community.ui.com/releases/UniFi-Network-Application-10-0-160/ce7adc5c-4b42-49d3-8447-971992c0bced)
...
docker run -d --init \
   ...
   --user unifi \
   --name unifi \
   ghcr.io/guymers/unifi:v10.0.160
```
